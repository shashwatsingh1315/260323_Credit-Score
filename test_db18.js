...
async function run() {
  const caseId = '817825d1-e9a6-45cf-933a-7a04701265e2'; // From earlier, in review
  ...
  console.log("Cycle exists?", !!cycle);
  ...
  if (cycle) {
    ...
    console.log("Tasks length:", taskData?.length, "Error:", error);
  }
}
run();
