...
export default function NotificationDropdown() {
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {showNotifs && (
        <div className="absolute top-full mt-2 right-0 w-80 max-w-[92vw] bg-card border border-border rounded-xl shadow-lg z-50 overflow-hidden flex flex-col max-h-96">
