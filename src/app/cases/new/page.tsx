          ...
          {step === 1 && (
            <div className={styles.formSection}>
              ...
              <div className={styles.actions}>
                <button type="button" onClick={() => setStep(2)} disabled={!canGoNext(1)} className={cn("btn-primary", canGoNext(1) ? "opacity-100" : "opacity-50")}>Continue</button>
              </div>
            </div>
          )}
          ...
          {step === 2 && (
            <div className={styles.formSection}>
              ...
              <div className={styles.actions}>
                ...
                <button type="button" onClick={() => setStep(3)} disabled={!canGoNext(2)} className={cn("btn-primary", canGoNext(2) ? "opacity-100" : "opacity-50")}>Continue</button>
              </div>
            </div>
          )}
          ...
          {step === 3 && (
            <div className={styles.formSection}>
              ...
              <div className={styles.actions}>
                ...
                <button type="button" onClick={() => setStep(4)} disabled={!canGoNext(3)} className={cn("btn-primary", canGoNext(3) ? "opacity-100" : "opacity-50")}>Continue</button>
              </div>
            </div>
          )}
          ...
          {step === 4 && (
            <div className={styles.formSection}>
              ...
              <div className={styles.actions}>
                ...
                <button type="button" onClick={() => setStep(5)} disabled={!canGoNext(4)} className={cn("btn-primary", canGoNext(4) ? "opacity-100" : "opacity-50")}>Continue</button>
              </div>
            </div>
          )}
